...
const Transaction: React.FC = () => {
    ...
    const fetchWaitingPayment = async () => {
        try {
            const response = await fetch('http://localhost:8080/api/customer/orders/waiting-payment', {
                method: 'POST',
                headers: {
    ...
    const handlePayment = async (orderId: number) => {
        try {
            const response = await fetch('http://localhost:8080/api/customer/orders/pay', {
                method: 'POST',
                headers: {
                    'Content-Type': 'application/json',
                },
