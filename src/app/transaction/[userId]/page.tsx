                            ...
                            <div className="flex w-1/5 flex-row gap-3 py-4">
                                ...
                                <>
                                    <button
                                        ...
                                        className="w-2/4 rounded-lg bg-blue-500 text-white-100 px-2 py-2 hover:bg-blue-700"
                                    >
                                        Bayar Sekarang
                                    </button>
                                    <button
                                        onClick={() => handleCancel(order.id)}
                                        className="w-2/4 rounded-lg bg-red-500 text-white-100 px-2 py-2 hover:bg-red-700"
                                    >
                                        Cancel
                                    </button>
